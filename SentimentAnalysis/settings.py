...
ALLOWED_HOSTS = ['marketanalysisapp.azurewebsites.net', 'localhost', '127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'SentimentAnalysisApp.apps.SentimentanalysisappConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'SentimentAnalysisApp/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
